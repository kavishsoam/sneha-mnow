...
@Component({
  selector: 'app-cost-profit-customer',
  templateUrl: './cost-profit-customer.component.html',
  styleUrls: ['./cost-profit-customer.component.css']
})
export class CostProfitCustomerComponent implements OnInit {
  ...
  paymentMethodsPieChart() {
    ...
    // Create chart instance
    let chart = am4core.create("pieChartPaymentMethod", am4charts.PieChart);
  ...
  profitPieChart() {
    ...
    // Create chart instance
    let chart = am4core.create("profitPieChart", am4charts.PieChart);
